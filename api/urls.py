...
urlpatterns = [
    path('products/images/', views.upload_product_image, name='product-images'),
    ...
    path('products/category/<slug:category_name>/', views.get_products_by_category, name='products-by-category'),
]